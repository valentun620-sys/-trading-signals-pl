...
// Повний список пар (можна розширювати)
const PAIRS_DATA = [
...
const I18N = {
    pl: {
        app_title: "Signal AI Pro", hero_title: "Handluj z AI", hero_sub: "Inteligentne sygnały для zyskownego handlu",
...
// Функція закриття при кліку на фон
...
function closePopups() {
    ...
    document.getElementById("cpSearch").value = ""; // Очищуємо пошук при закритті
}
...
// РОЗШИРЕНИЙ ЧАС (як на Pocket Option)
function renderExpiry() {
    const grid = document.getElementById("exGrid");
    const times = ["5s", "10s", "15s", "30s", "1m", "2m", "3m", "5m", "10m", "15m", "30m", "1h", "4h"];
