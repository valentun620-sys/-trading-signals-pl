...
// Languages + I18N
// =============================
// Знайди у своєму файлі блок SUP_LANGS і заміни на цей:
const SUP_LANGS = [
    { code: "en", label: "English", short: "EN", dir: "ltr" },
    { code: "pl", label: "Polski", short: "PL", dir: "ltr" },
];

// Повністю заміни свій об'єкт I18N на цей (тут тільки EN та PL):
const I18N = {
    en: {
    ...
    pl: {
        ...
        faq_q2: "Dlaczego status VIP?",
        faq_a2: "VIP przyspiesza analizę, poprawia jakość sygnałów i daje dodatkowe narzędzia.",
        faq_q3: "Co to jest czas wygaśnięcia?",
        faq_a3: "Moment, w którym transakcja zostaje automatyчно zamknięta.",
        faq_q4: "Czym różnią się modele?",
        faq_a4: "Modele różnią się wydajnością i mocą obliczeniową.",
        faq_q5: "Czy sygnały są dokładne?",
        faq_a5: "Sygnały są agregowane з wielu rynków dla większej stabilności.",
